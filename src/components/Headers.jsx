...
function Headers() {
  ...
  useEffect(() => {
    async function getDetailMovie() {
      try {
        const response = await axios.get(`https://api.themoviedb.org/3/movie/968051?api_key=56d94a0cdb1adcc9a7ba5533448786e4&language=en-US`);
        const response2 = await axios.get(`https://api.themoviedb.org/3/movie/1151534?api_key=56d94a0cdb1adcc9a7ba5533448786e4&language=en-US`);
        const response3 = await axios.get(`https://api.themoviedb.org/3/movie/762430?api_key=56d94a0cdb1adcc9a7ba5533448786e4&language=en-US`);
